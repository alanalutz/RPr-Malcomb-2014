...
> H2: There is no perfect positive correlation between Malcom et al's ranking of locations by climate vulnerability and our reproduction study's ranking of locations by climate vulnerability.
...
I add a small value (1) to each indicator to remove 0 values, then multiply the indicators together, subtract 1, and take the square root.
Finally, I log transform the data for ease of visualization and comparison.

$$
Vulnerability = sqrt((40 - Adaptive Capacity) * Livelihood Sensitivity * Drought Exposure * Flood Risk)
$$
