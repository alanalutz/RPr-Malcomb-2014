...
tm_shape(vulnerability_g) +
  tm_polygons(palette = c("#FFFF75", "#CF4611"), style="pretty", breaks = c(vuln_g_min, vuln_g_max),
...
tmap_mode('plot')
tm_shape(vulnerability_r) +
  tm_raster(col = "diffv", palette = "PiYG", style = "cont", breaks = c(-range,0,range), title = "") +
  tm_layout(legend.outside = TRUE, main.title = "Vulnerability: Reproduction - Original", main.title.size = 1, frame=FALSE) +
  tm_grid(labels.col="gray", lines=FALSE)
```
...
tm_shape(vulnerability_g) +
  tm_raster(col = "diffv", palette = "PiYG", style = "cont", breaks = c(-range,0,range), title = "") +
  tm_layout(legend.outside = TRUE, main.title = "Vulnerability: Geometric - Additive", main.title.size = 1, frame=FALSE) +
  tm_grid(labels.col="gray", lines=FALSE)
```
